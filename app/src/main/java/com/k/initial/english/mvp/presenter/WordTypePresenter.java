 ...
 */
@ActivityScope
public class WordTypePresenter extends BasePresenter<WordTypeContract.Model, WordTypeContract.View> {

    @Inject
    RxErrorHandler mErrorHandler;
    @Inject
    List<WordTypeEntity> mList;
    @Inject
    RecyclerView.Adapter mAdapter;
    private int preEndIndex;

    @Inject
    public WordTypePresenter(WordTypeContract.Model model, WordTypeContract.View rootView) {
...
//        getList(true); // 打开 App 时自动加载列表
    ...
    public void getList(final boolean pullToRefresh) {
        mModel.getList()
                ...
                .subscribe(new ErrorHandleSubscriber<List<WordTypeEntity>>(mErrorHandler) {
                    @Override
                    public void onNext(List<WordTypeEntity> data) {
                        if (pullToRefresh) {
